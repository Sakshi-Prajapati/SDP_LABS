...
//DART CLASSES
//classes are like architectural blueprint that
//tell the system how to make an object where object will store.

/*
  //declaration of basic class
  class myclass {
    var property = "helloo..."; // class property
  ...
  void main() {
    final user = new User();
    user.name = "sakshi"; // assign values to property
  }
*/
...
//Constructor
/*constructor are method with same name as class name and it return 
...
class Student {
  Student({firstName = 'sakshi', lastname = 'prajapati', grade = 0})
