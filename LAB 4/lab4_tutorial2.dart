...
// Nullability
// value null cannot be assign to int variable
/* Non nullabel types 
   dart types are non-nullable by default.
   thus guaranteed that they cannot never contain null value
   this is called sound null safety*/

/* 
   Non nullable types
   nullabel type can contain null value
*/
...
/*
  ...
  //String profession; //must be initiallized

  String profession = "basketball player";

  const ilove = "dart";// string type
*/
