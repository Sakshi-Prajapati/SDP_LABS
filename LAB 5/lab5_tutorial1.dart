...
void main(List<String> arguments) {
  ...
  */
  ...
  //Deeply immutable
    const desserts = [
      ...
      'hetal',
      'riddhi'
    ]; //This is same as , final desserts = const['sakshi','hetal','riddhi'];
  // Below 3 will not work because list is const
  // desserts.add('sakshi');
  // desserts.remove('hetal');
  // desserts[0] = 'abc';
  ...
  */
  ...
  print(drinks.length); //By using this also we can check if list is empty or not
  ...
  */
  ...
  // Challenge 3:
  User user1 = User(1, 'sakshi');
  User user2 = User(2, 'hetal');
  User user3 = User(3, 'riddhi');
